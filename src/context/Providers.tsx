...
//Web3
import { RainbowKitProvider, lightTheme, DisclaimerComponent, connectorsForWallets } from '@rainbow-me/rainbowkit';

import { rainbowWallet, metaMaskWallet, coinbaseWallet, walletConnectWallet, injectedWallet } from '@rainbow-me/rainbowkit/wallets';
...
const connectors = connectorsForWallets([
  ...
  {
    groupName: 'Others',
    wallets: [walletConnectWallet({ chains }), injectedWallet({ chains, shimDisconnect: true })],
  },
]);
...
const Disclaimer: DisclaimerComponent = ({ Text, Link }) => (
  <Text>
    <b>This app runs on the Goerli testnet</b>
    <br />
    <b style={{ color: 'red' }}>Connect a wallet that supports testnets, like Coinbase, Rainbow Wallet, or MetaMask.</b>
  </Text>
);
