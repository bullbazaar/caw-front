import { Wrap, WrapItem, useColorModeValue, Button, Text, Center, useDisclosure, VStack, useToken } from '@chakra-ui/react';
    ...
    >
      ...
      {showNewPostButton && (
        <ItemWrapper padding="0.0rem" minW="0.0rem">
          <Button _hover={{ bg: hoverColor }} variant={'ghost'}>
            + Post
          </Button>
        </ItemWrapper>
      )}
      ...
      <ItemWrapper padding="0.0rem" minW="0.0rem">
        <TopBarMenuButton iconColor={textColor} textColor={textColor} itemIconColor={menuItemIconColor} />
      </ItemWrapper>
    </Wrap>
  );
}
