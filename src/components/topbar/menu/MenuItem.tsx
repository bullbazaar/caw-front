...
export default function MenuItem({ useLink, href, useIcon = true, icon, iconColor, label, isExternal, onClick }: MenuItemProps) {
  ...
  return (
    <ListItem>
      <Link as={useLink ? NextLink : 'div'} isExternal={isExternal} href={href} textDecoration="none" cursor="pointer" onClick={onClick}>
        <HStack borderRadius="md" padding={4} _hover={{ bg: hoverColor }} textDecoration="none">
