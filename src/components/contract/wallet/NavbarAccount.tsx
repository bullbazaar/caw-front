        ...
        <HStack width={'100%'}>
          ...
          <VStack textAlign="left" alignItems="flex-start">
            ...
            <HStack>
              ...
              <Text noOfLines={1} fontSize="sm" color="gray.600" cursor={'pointer'} onClick={chain?.name ? openChainModal : openAccountModal}>
                {chain?.name || t('labels.unknownChain')}
              </Text>
            </HStack>
            <Text noOfLines={1} fontSize="sm" color="gray.600" cursor={'pointer'} wordBreak="break-all" as="p" onClick={openAccountModal}>
