    ...
    <Box id="sidebar" minH="100vh" bg={bg}>
      ...
      >
        ...
        <DrawerContent>
          ...
          <DrawerBody overflow="auto" onClick={onClose}>
            {LinkItems.map((link) => (
              <NavItem key={link.name} name={t(link.name)} icon={link.icon} link={link.link} onClick={onClose} />
            ))}
          </DrawerBody>
          <DrawerFooter id="drawer-footer" textAlign="center" justifyContent="center" alignItems="center" alignContent={'center'}>
