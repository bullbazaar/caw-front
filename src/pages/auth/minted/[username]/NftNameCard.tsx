  ...
  return (
    <Center py={12}>
      <VStack spacing={8}>
        ...
        <Box role={'group'} p={6} maxW={'330px'} w={'full'} bg={bgBox} boxShadow={'2xl'} rounded={'lg'} pos={'relative'} zIndex={1}>
          <Box
            rounded={'lg'}
            mt={-12}
            pos={'relative'}
          ...
          >
            <Image rounded={'lg'} height={230} width={282} objectFit={'cover'} alt={userName} src={image} />
          </Box>
          <Stack pt={10} align={'center'}>
            ...
            <Stack direction={'column'} align={'center'}>
              <Link isExternal color={'blue.400'} target="_blank" href={blockExplorerUrl}>
                <b>{`${t('labels.the')} ${t('labels.block_explorer')}`}</b> <ExternalLinkIcon mx="2px" />
              </Link>
              {` and `}
              <Link isExternal color={'blue.400'} target="_blank" href={openSeaUrl}>
