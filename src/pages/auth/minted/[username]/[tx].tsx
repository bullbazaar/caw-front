  ...
  return (
    <PageWrapper title={t('minted_page.title')}>
      <Container maxW={'container.xl'} h="container.lg" pt={10}>
        ...
        <WrapperFadeAnimation show={!loading}>
          <Box>
            <NftNameCard blockExplorerUrl={explorerUrl} openSeaUrl={nftURL} image={image} userId={userId} userName={userName as string} />
            <Divider />
            <Spacer h={10} />
            <Center>
              <Stack spacing={5} direction={['column', 'row']} w={{ base: '-webkit-fill-available', md: 'inherit' }}>
