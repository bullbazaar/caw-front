...
export default function HomeEconomySection() {
  ...
  return (
    <Box id="home-economy-section" py={'24'} as={MotionViewport}>
      <Stack direction={{ base: 'column', md: 'row' }} spacing={{ base: 4, lg: 10 }} py={10}>
        <HStack>
          <VStack spacing={2} textAlign="left" alignItems={'ba'}>
            <m.div variants={varFade().inUp}>
              <Text as="b" fontSize="md" textTransform={'uppercase'} mb={2} color={textColor} textAlign="left">
                {t('home.social_eco')}
              </Text>
            </m.div>
            <m.div variants={varFade().inUp}>
              <Text as="b" fontSize="5xl" mb={3} textAlign="left">
            ...
            <m.div variants={varFade().inUp}>
              <Text mb={5} color={textColor} textAlign="left">
                ...
                <br />
                <br />
                <span>{t('home.social_eco_label_4')}</span>
              </Text>
            </m.div>
            <m.div variants={varFade().inUp}>
              <NextLink href={PATH_PAGE.discover} passHref>
                <Button size="lg" bg={buttonColor} borderColor={buttonBorderColor} borderWidth="thin" textTransform={'capitalize'} variant="solid">
        ...
        <VStack spacing={2} textAlign={{ base: 'left', sm: 'center' }}>
          <Box display="flex" alignItems="center" position="relative" justifyContent="center" gap={4}>
            {[...Array(3)].map((_, index) => {
