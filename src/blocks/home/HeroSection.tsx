...
export const DecentralizedTextStyle = styled('span', {
  baseStyle: (prop: any) => ({
    background: `linear-gradient(to right, ${prop?.theme.colors.caw[`dark`]} 0%, ${prop?.theme.colors.caw[`darker`]}  13%, ${
      prop?.theme.colors.caw[`main`]
    }  100%)`,
        ...
        <Stack direction={['column', 'row']} p={2}>
          <Box w="100%" alignSelf="center">
            <m.div variants={varFade().inDown}>
              <ContentAlign>
                <Text fontSize="4xl" fontWeight="bold" textAlign={isMd ? 'left' : 'center'}>
                  TEH
                  <br />
