...
const _mock = {
  ...
  image: {
    cover: (index: number) => `https://picsum.photos/seed/${index}/600/400`,
    feed: (index: number) => `https://picsum.photos/seed/${index}/600/400`,
    product: (index: number) => `https://picsum.photos/seed/${index}/600/400`,
    avatar: (index: number) =>
